  ...
  <div id="footer"><footer>
    <div class="container">
      <div id="footer-content">
        <?php if( !dynamic_sidebar( 'Footer' ) ){ ?><!--Widgetized Footer--><?php } ?>
        ...
        <p>Built on the <a href="http://whiteboardframework.com/">Whiteboard Framework for Wordpress</a> <span class="amp">&amp;</span> <a href="http://lessframework.com">Less Framework</a>.
